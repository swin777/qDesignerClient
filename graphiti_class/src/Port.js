...
graphiti.Port = graphiti.shape.basic.Circle.extend({
    ...
    init : function( name)
    {
        ...
        this.connectionAnchor = new graphiti.layout.anchor.ConnectionAnchor(this);
     ...
     *
     * @param {graphiti.layout.anchor.ConnectionAnchor} [anchor] the new source anchor for the connection
     **/
    setConnectionAnchor:function( anchor)
    {
        ...
        {
    		anchor = new graphiti.layout.anchor.ConnectionAnchor( );
    	}
