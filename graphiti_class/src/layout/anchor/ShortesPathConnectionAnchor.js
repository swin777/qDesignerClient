...
/**
 * @class graphiti.layout.connection.ShortesPathConnectionAnchor
 * 
 ...
 */
graphiti.layout.anchor.ShortesPathConnectionAnchor = graphiti.layout.anchor.ConnectionAnchor.extend({

	NAME : "graphiti.layout.anchor.ShortesPathConnectionAnchor",
	 ...
	 * 
	 * @param {graphiti.geo.Point} ref The reference Point in absolute coordinates
	 * @return {graphiti.geo.Point} The anchor's location
	 */
	getLocation : function(ref) {
	     ...
	     *    6 | 5 | 4
	     */
	    var octant = r.determineOctant(new graphiti.geo.Rectangle(ref.x,ref.y,2,2));
		...
		case 0:
		    return r.getTopLeft();
		case 1:
		    return new graphiti.geo.Point(ref.x,r.getTop());
        case 2:
            return r.getTopRight();
        case 3:
            return new graphiti.geo.Point(r.getRight(),ref.y);
		case 4:
            return r.getBottomRight();
        case 5:
            return new graphiti.geo.Point(ref.x,r.getBottom());
		case 6:
            return r.getBottomLeft();
        case 7:
            return new graphiti.geo.Point(r.getLeft(),ref.y);
		}
