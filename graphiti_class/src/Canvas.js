...
graphiti.Canvas = Class.extend(
{
     ...
     * You can now relead another model to the canvas with a {@link graphiti.io.Reader}
     * 
     * @since 1.1.0
     */
    clear : function(){
...
//        this.paper.setSize(this.html.width(), this.html.height());
    ...
    /**
     * @method
     * Returns the best figure at the location [x,y]. It is a simple hit test. Keep in mind that onyl visible objects 
     * are returend.
     *
     * @param {Number} x The x position.
     * @param {Number} y The y position.
    ...
    * @template
    ...
    /**
     * @private
     * @param {Number} whichButton 1=left; 2=middle; 3=right
     * @since 1.1.0
     **/
