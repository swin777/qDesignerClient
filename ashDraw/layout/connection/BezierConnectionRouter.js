define(["dojo/_base/declare", "ashDraw/layout/connection/ManhattanConnectionRouter", "ashDraw/util/ArrayList"], function(declare){
	return declare("ashDraw.layout.connection.BezierConnectionRouter", ashDraw.layout.connection.ManhattanConnectionRouter, {
		NAME : "ashDraw.layout.connection.BezierConnectionRouter",
...
//	         			      			
	...
	// 
	       ...
	       var p = ps.get(0);
	       var path = [["M",p.x," ",p.y]];
	       var pathSub = new ashDraw.util.ArrayList(); 
	       if(ps.getSize()>3){
	       		pathSub.add("C");
	       }else{
	       		pathSub.add("Q");
